...
data.forEach(circle => {
    ...
    svg.append("path")
        ...
        .attr("fill", "#d3f7ee") // Light blue color for unfilled part
        .attr("d", backgroundArc);

    svg.append("path")
        .datum({ endAngle: 0 })
        .attr("class", "arc")
        .attr("fill", "#1bd0a3") // You can change the fill color as needed
        .attr("d", arc);

    svg.append("text")
        .attr("class", "percentage")
        .attr("text-anchor", "middle")
        .attr("dy", "0.3em") // Adjust this value to vertically center the text
...
// Example usage: Fill up the circles all at once
data.forEach(circle => {
